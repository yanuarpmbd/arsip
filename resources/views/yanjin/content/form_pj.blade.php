<div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form class="form-horizontal" action="{{route('pj.submit')}}" method="post">
                @csrf
                <div class="form-group"><label class="col-lg-2 control-label">Nama PJ</label>
                    <div class="col-lg-10">
                        <input placeholder="Nama Penanggungjawab Izin" name="nama_pj" id="nama_pj" class="form-control">
                    </div>
                </div>
