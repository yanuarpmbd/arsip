<div class="row">
    <form action="{{ route('rekap.sektor') }}">
        <div class="col-sm-4">

        </div>
        <div class="col-sm-4">

            <div class="form-group"><label class="col-lg-4 control-label">Jenis Sektor*</label>
...
<div class="col-lg-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <button class="btn btn-danger" style="align-content: center; text-align: center" id="btntable2excelsektor">Save it</button>
