    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="/home/skpd"><i class="fa fa-home"></i> <span class="nav-label">Home</span> </a>
                </li> {{--Settings--}}
                <li>
                    <a href="/skpd"><i class="fa fa-th-large"></i> <span class="nav-label">Rekap Arsip</span> </a>
                </li> {{--Rekap Arsip--}}
                <li>
                    <a href="/settingskpd"><i class="fa fa-gear"></i> <span class="nav-label">Settings</span> </a>
                </li>{{--Settings--}}
            </ul>
